...
public final class runKmeans extends AbstractJob {
  
  private static final Logger log = LoggerFactory.getLogger(runKmeans.class);
  ...
  public static void main(String[] args) throws Exception {
    if (args.length > 0) {
      ...
      ToolRunner.run(new Configuration(), new runKmeans(), args);
    } else {
